...
fn main() {
    println!("╔════════════════════════════════════════════════════════════════╗");
    println!("║     Entrenamiento Automático de Parámetros V8.6               ║");
    println!("╚════════════════════════════════════════════════════════════════╝\n");
    ...
    let mut best_params = V86Params::default();
    ...
    // Guardar resultados
    let mut file = File::create("assets/v86_training_results.txt").unwrap();
    writeln!(file, "# Resultados de entrenamiento V8.6").unwrap();
    ...
    println!("\n✓ Resultados guardados en: assets/v86_training_results.txt");
}
